<%-- 
    Document   : AddAhorro
    Created on : 18/03/2019, 03:08:06 PM
    Author     : JMartinNavas
--%>
...
<html>
    <head>
        ...
        <title>Agregar Ahorro al Conductor</title>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Registrar Nuevo Ahorro</h4>
                            <p class="category">Complete cada uno de los campos</p>
                        </div>
                        <div class="card-content">
                            <form:form method="post" commandName="Ahorros"  >
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Fecha del Ahorro</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Cantidad a Ahorrar</label>
                                            <form:input type="number" path="cantidad" class="form-control" />
                                            <form:errors path="cantidad"  cssClass="alert alert-danger" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="submit" class="btn btn-primary pull-right" value="Crear Ahorro" />
