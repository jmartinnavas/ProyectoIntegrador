<%-- 
    Document   : ahorro
    Created on : 18/03/2019, 03:04:03 PM
    Author     : JMartinNavas
--%>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="red">
                                        <h4 class="title">Ahorros del Conductor</h4>
                                        <p class="category">Informacion General del modulo</p>
                                        <a class="btn-floating" href=<c:url value="AddAhorro.htm?cedula=${cedula}"></c:url>><i class="material-icons">add</i></a>
                                        </div>
                                        <div class="card-content table-responsive">
                                            <table class="table">
                                                <thead class="text-primary">
                                                <th data-field="placa"  >Fecha del Ahorro</th>
                                                <th data-field="marca" >Cantidad</th>
                                                <th data-field="modelo" >Opciones</th>
                                                ...
                                                <c:forEach items="${datos}" var="dato">
                                                    <tr style="background-color:#FFFF;">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a  href="<c:url value="DeleteAhorro.htm?id=${dato.id}"></c:url>">
