                    ...
                    <nav class="navbar navbar-transparent navbar-absolute">
                        <div class="container-fluid">
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand" href="#">Modificar Vehiculo</a>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header" data-background-color="purple">
                                            <h4 class="title">Modificar Vehiculo</h4>
                                            <p class="category">Ingrese La Información</p>

                                        </div>
                                        <div class="card-content table-responsive">
                                            <table class="table">

                                          <form:form method="post" commandName="vehiculos">
                        <form:label path="Placa"><h5>Placa</h5></form:label>
                        <form:input path="Placa"/>
                        <form:label path="marca"><h5>Marca</h5></form:label>
                        <form:input path="marca" />
                        <form:label path="modelo"><h5>Modelo</h5></form:label>
                        <form:input path="modelo" />
                        <form:label path="motor"><h5>Motor</h5></form:label>
                        <form:input path="motor" />
                        <form:label path="fecha_ingreso"><h5>Fecha Ingreso</h5></form:label>
                        <form:input path="fecha_ingreso" />
                        <form:label path="foto"><h5>foto</h5></form:label>
