            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="btn-group-vertical">
                        <a type="submit" class="btn btn-danger" href="<c:url value="balanceGeneral.htm"></c:url>"> REPORTE GENERAL </a>
                            <br>
                            <a type="submit" class="btn btn-danger" href="<c:url value="balanceGeneralConductores.htm"></c:url>"> BALANCE GENERAL CONDUCTORES </a>
                            <br>
                            <a type="submit" class="btn btn-danger" href="<c:url value="balanceGeneralVehiculos.htm"></c:url>"> BALANCE GENERAL VEHICULOS </a>
                      <br>
                            <a type="submit" class="btn btn-danger" href="<c:url value="incidenciaCritica.htm"></c:url>"> INCIDENCIA MAS CRITICA </a>
                        </div>
