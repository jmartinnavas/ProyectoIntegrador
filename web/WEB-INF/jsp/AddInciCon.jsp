<%-- 
    Document   : AddInciCon
    Created on : 10/03/2019, 04:41:37 PM
    Author     : JMartinNavas
--%>
...
<html>
    <head>
        ...
        <title>Crear Incidencia de vehiculo Conductor</title>
                ...
                <div class="col-md-8">
                    <div class="card">
                        <div class="card-header" data-background-color="red">
                            <h4 class="title">Registrar Incidencia del Conductor</h4>
                            ...
                            <form:form method="post" commandName="InciConductores" enctype="multipart/form-data" >
                                ...
                                <div class="col-md-6">
                                    <div class="form-group label-floating">
                                        ...
                                        <form:input  path="conductor" class="form-control" value="${cedula}"  />
