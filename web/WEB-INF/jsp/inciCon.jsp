...
<html lang="en">
    <head>
        ...
        <title>Incidencias de Vehiculos</title>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header" data-background-color="red">
                                        <h4 class="title">Incidencias del Conductor</h4>
                                        <p class="category">Informacion General del modulo</p>
                                        <a class="btn-floating" href=<c:url value="AddInciCon.htm?cedula=${cedula}"></c:url>><i class="material-icons">add</i></a>
                                        </div>
                                        <div class="card-content table-responsive">
                                            <table class="table">
                                                <thead class="text-primary">
                                                <th data-field="placa"  >Fecha de Inicio</th>
                                                ...
                                                <c:forEach items="${datos}" var="dato">
                                                    <tr style="background-color:#FFFF;">
                                                        <td><c:out value="${dato.fecha_inicio}"/></td>
