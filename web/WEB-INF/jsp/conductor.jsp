<%-- 
    Document   : conductor
    Created on : 22/02/2019, 01:09:24 PM
    Author     : JMartinNavas
--%>
...
<html lang="en">
    <head>
        ...
        <title>Modulo Conductores</title>
...
<li>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<c:url value="ConsultCon.htm?id=${dato.cedula}"></c:url>">
                                                                ...
                                                                <a href="<c:url value="EditCon.htm?id=${dato.cedula}"></c:url>">
                                                                    <i class="material-icons right">edit</i>
                                                                </a>
                                                                <a href="<c:url value="DeleteCon.htm?id=${dato.cedula}"></c:url>">
    ...
    <script src=<c:url value="/PUBLIC/resources/js/custom.js"></c:url>></script>
</html>